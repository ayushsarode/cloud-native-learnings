...
type TodoServiceClient interface {
	...
	GetTodo(ctx context.Context, in *GetTodoRequest, opts ...grpc.CallOption) (*CreateTodoResponse, error)
...
func (c *todoServiceClient) GetTodo(ctx context.Context, in *GetTodoRequest, opts ...grpc.CallOption) (*CreateTodoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CreateTodoResponse)
...
type TodoServiceServer interface {
	...
	GetTodo(context.Context, *GetTodoRequest) (*CreateTodoResponse, error)
...
func (UnimplementedTodoServiceServer) GetTodo(context.Context, *GetTodoRequest) (*CreateTodoResponse, error) {
